...
export default function Topbar() {
  ...
  return (
    <>
      <nav className="relative m-auto">
        <div className="py-4 px-4 flex justify-between items-center max-w-[1500px] m-auto">
        ...
        <Link className=" leading-none hidden lg:block" href="/dashboard">
          Login
        </Link>
        </div>
      </nav>
